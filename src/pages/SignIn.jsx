      ...
      <div className="flex-1 flex flex-col justify-center items-center px-8 py-12 relative z-10">
        ...
        <div className="relative w-full max-w-sm">
          ...
          <div className="mt-4 rounded-xl px-4 py-3 text-xs text-center"
            style={{ backgroundColor: 'rgba(255,255,255,0.03)', border: `1px solid ${BORDER_DIM}`, color: TEXT_MUTED }}>
            Google sign-in is temporarily disabled. Please use email and password above.
          </div>
