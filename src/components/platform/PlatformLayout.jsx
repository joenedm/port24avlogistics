...
import { Building2, LogOut, ShieldCheck, Loader2 } from 'lucide-react';
...
export default function PlatformLayout() {
  ...
  useEffect(() => {
    ...
    // Timeout: if session check hangs for 8s, send to login
    ...
    const verify = async () => {
      try {
        ...
        // Hardcoded platform admins always get through
